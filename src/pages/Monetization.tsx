...
export default function Monetization() {
  ...
  return (
    <AppLayout title="Monetização" subtitle="Ganhe dinheiro partilhando e ajudando a comunidade">
      <ModuleGuard
        moduleKey="basic"
        title="Monetização & Referenciamento"
        description="Convide amigos, ganhe comissões por cada assinatura e acompanhe os seus rendimentos diretamente na plataforma."
      >
